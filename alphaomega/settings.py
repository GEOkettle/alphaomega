"""
Django settings for alphaomega project.
...
SECRET_KEY = '9ek@ubu88&4l_y859azck^%o5(i&(!9w5d%22gqn%of+gpj(1+'
...
WSGI_APPLICATION = 'alphaomega.wsgi.application'
